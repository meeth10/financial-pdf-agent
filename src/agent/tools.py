...
def get_line_item(conn: sqlite3.Connection, entity: str, metric: str, period: str,
    ...
    return {
        ...
        "confidence": "HIGH" if (row["extraction_confidence"] or 0) >= 0.9 else
...
def calculate_yoy(conn: sqlite3.Connection, entity: str, metric: str,
    ...
    return {"status": "DERIVED", "metric": metric, "period_current": period_current,
            "period_prior": period_prior, "value_current": current["value"],
            "value_prior": prior["value"], "change": round(change, 2),
...
TOOL_SCHEMAS = [
    {"type":"function","function":{"name":"get_line_item","description":"Look up a single reported financial metric.","parameters":{"type":"object","properties":{"entity":{"type":"string"},"metric":{"type":"string"},"period":{"type":"string"},"statement":{"type":"string","enum":["balance_sheet","income_statement","cash_flow"]},"consolidated":{"type":"boolean"}},"required":["entity","metric","period"]}}},
    {"type":"function","function":{"name":"list_available_periods","description":"List fiscal periods available for an entity.","parameters":{"type":"object","properties":{"entity":{"type":"string"}},"required":["entity"]}}},
    {"type":"function","function":{"name":"list_available_metrics","description":"List normalized metrics available for an entity.","parameters":{"type":"object","properties":{"entity":{"type":"string"},"statement":{"type":"string","enum":["balance_sheet","income_statement","cash_flow"]}},"required":["entity"]}}},
    {"type":"function","function":{"name":"calculate_yoy","description":"Compute period-over-period change.","parameters":{"type":"object","properties":{"entity":{"type":"string"},"metric":{"type":"string"},"period_current":{"type":"string"},"period_prior":{"type":"string"},"statement":{"type":"string","enum":["balance_sheet","income_statement","cash_flow"]}},"required":["entity","metric","period_current","period_prior"]}}},
    {"type":"function","function":{"name":"export_to_excel","description":"Export stored statements to Excel.","parameters":{"type":"object","properties":{"entity":{"type":"string"},"output_path":{"type":"string"}},"required":["entity","output_path"]}}},
]

DISPATCH = {"get_line_item": get_line_item, "list_available_periods": list_available_periods,
            "list_available_metrics": list_available_metrics, "calculate_yoy": calculate_yoy,
